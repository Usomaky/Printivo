...
export default function CustomerCanvas(props) {
  ...
  useEffect(() => {
    ...
    axios
      .all([
        axios.get(
          `${CORE_API_BASE_URL}products/one-sided-business-cards.json?include=quotes`
        ),
        axios.get(`${CORE_API_BASE_URL}designs/eko-ile.json`),
      ])
      .then(
  ...
  function defineReviewPage() {
    ...
    window.ReviewPage = {
      open(data) {
        ...
        setState(...state, { images: data, price: product.minimum_price });
      },
  ...
  function configureCC() {
    // Product definition
    const { design, product } = state;
  ...
  function changeQuoteSelected(e) {
  ...
  function chooseAddon(addonKey, addonvalue, index, addNew, leftover) {
    computeAddon(
      state.product,
      state.addOnsAvailable,
  ...
  function saveDesign() {
    ...
    //   },
    // } = this.props
    const { ccData, images, product, design } = state;
  ...
  function finishDesign() {
    ...
    if (cart) {
      ...
      api.core
        .patch(`orders/${cart.id}.json`, data)
        .then((res) => {
              ...
              {step === 1 && (
                <div className='w-full'>
                  <div className='w-full'>
                    ...
                    <button
                      type='button'
                      className='go-to-review w-64 py-4 text-white text-center bg-tivo-magenta float-right my-5'
                      ...
                      <div className='w-full flex'>
                        ...
                        <div className='pl-3 w-1/2'>
                          <button
                            type='button'
                            disabled={loading}
                            className={`text-white text-center py-3 w-full ${
                              loading ? "h-16 bg-grey-light" : "bg-tivo-magenta"
                            }`}
