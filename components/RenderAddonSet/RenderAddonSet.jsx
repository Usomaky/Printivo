        ...
        addOnkeys.map((spec, index) => {
          ...
          return (
            <div key={spec} className="w-full pb-6 pt-4 border-b-2">
              <h5 className="mb-3 font-bold">{spec}</h5>
              <div className="w-full flex flex-wrap">
                            ...
                            >
                                ...
                                {tshirtSizes &&
                                  tshirtSizes.map((size, i) => (
                                    <div
                                      ...
                                      role="option"
                                      tabIndex={i}
                                      aria-selected={size === selectedSize.name}
                                      onClick={() => {
                                        chooseAddon(
                                          spec,
                                          { name: size },
                                      ...
                                      onKeyPress={(e) => e}
                                      className={`cursor-pointer w-10 h-10 mx-1 flex justify-center items-center border border-grey text-sm
                                            ${
                              ...
                              <select
                                ...
                                onChange={(e) => {
                                  ...
                                  const leftover = tshirtQuantity - totalCount;
                    ...
                    return (
                      <div key={subItemIndex} className="w-1/3 pr-2 mb-2">
                        <button
                          ...
                          className={`w-full items-center p-3 rounded
                ...
                {spec === "Shipping" ? (
                  <div className="w-full mt-2 mb-6 px-6 py-4 bg-grey-lighter text-sm">
                    <div>
                      <p>
                        <strong>Standard:</strong> 3 - 5 working days for Lagos,
                        5 - 7 working days for other cities
                        <br />
                      </p>
                      <p className="mb-0">
                        <strong>Express:</strong> <em>Lagos only</em>. Same day
                        delivery for orders placed before 10AM, 24-hour delivery
                        for orders after 10AM.
                      </p>
                    </div>
                  </div>
                ) : (
...
RenderAddOnSet.propTypes = {
  addOns: PropTypes.shape({}).isRequired,
  addOnsSelected: PropTypes.shape({}).isRequired,
  chooseAddon: PropTypes.func.isRequired,
  isTshirt: PropTypes.bool.isRequired,
  tshirtQuantity: PropTypes.number.isRequired,
};
