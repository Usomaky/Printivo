...
import { slugify, exceptionToErrors } from "@/utils/index";
...
const Sell = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      switch (true) {
        case Boolean(error?.data?.errors?.stores?.store_exist):
          Toastr.error(error.data?.errors?.stores?.store_exist);
          break;

        case Boolean(error?.data?.errors?.slug?.unique):
          Toastr.error(error.data.errors.slug.unique);
          break;

        case Boolean(error?.data?.errors?.username):
                ...
                <div>
                  ...
                  <div className="text-blue-dark">
                    <p className="font-sf--reg text-sm">
                      Your store has been succesfully created, kindly check your
                      email to confirm your ownership and start selling!
                    </p>
                  </div>
                </div>
              </section>
